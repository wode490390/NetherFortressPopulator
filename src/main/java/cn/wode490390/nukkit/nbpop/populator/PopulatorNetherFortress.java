package cn.wode490390.nukkit.nbpop.populator;
...
import cn.wode490390.nukkit.nbpop.scheduler.CallbackableChunkGenerationTask;
import cn.wode490390.nukkit.nbpop.structure.NetherBridgePieces;
import cn.wode490390.nukkit.nbpop.structure.StructurePiece;
import cn.wode490390.nukkit.nbpop.structure.StructureStart;
...
public class PopulatorNetherFortress extends Populator {
    ...
    public void populate(ChunkManager level, int chunkX, int chunkZ, NukkitRandom random, FullChunk chunk) {
        if (chunk.getBiomeId(7, 7) == EnumBiome.HELL.id) {
            ...
            if (random.nextBoundedInt(3) == (0x51d8e999 & 3) // salted
                ...
                if (start.isValid()) { //TODO: serialize nbt
                    ...
                    NetherFortressPlugin.debug(this.getClass().getSimpleName(), chunkX << 4, chunkZ << 4);
                }
            }
        }
    }
